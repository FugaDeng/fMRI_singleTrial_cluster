...
matlab -nodisplay -nodesktop -nojvm -singleCompThread -r "cd('/mnt/munin2/Cabeza/SchemRep.01/Scripts/SingleTrialModelling'); sortST('$SUB'); exit" 
...
OUT_logDIR=${EXPERIMENT}/Scripts/SingleTrialModelling/job_sort_log
